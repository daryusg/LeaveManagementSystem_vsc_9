        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    RoleId = table.Column<string>(type: "nvarchar(72)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<string>(type: "nvarchar(72)", nullable: false),
                    ClaimType = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ClaimValue = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UserId = table.Column<string>(type: "nvarchar(72)", maxLength: 72, nullable: false),
                    RoleId = table.Column<string>(type: "nvarchar(72)", maxLength: 72, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmployeeId = table.Column<string>(type: "nvarchar(72)", nullable: false),
                    ReviewerId = table.Column<string>(type: "nvarchar(72)", nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "8a862852-9e68-4bcc-b624-220e9b060cf9", 0, "bff9869ba62a4a4986479a91c0d6890b", new DateTime(1991, 7, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "admin_bu1@localhost.com", true, "Admin_Bu1", "Default", false, null, "ADMIN_BU1@LOCALHOST.COM", "ADMIN_BU1@LOCALHOST.COM", "AQAAAAIAAYagAAAAEJ5jT7bufJvPmguGXW9QAbwUO4GGPlOPUpZDSdL3J5uk9pgBbth4gkSONtFF3+A8kg==", null, false, "8dd5bb17-2a8e-4998-a66b-8611e32a9b9a", false, "admin_bu1@localhost.com" },
                    { "a23d75b8-c842-4164-9cb1-f9e7c2366c3b", 0, "939075471b23410b832121d4f56ebeb3", new DateTime(1992, 7, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "testuser@leavemanagement.com", true, "test", "user", false, null, "TESTUSER@LEAVEMANAGEMENT.COM", "TESTUSER@LEAVEMANAGEMENT.COM", "AQAAAAIAAYagAAAAEFmo3ccUYE1zfv2SyMqUSjAxLxupY6bcQEuHLVIgF+ShU/lOkD2lbsPYrlcXNnKNnQ==", null, false, "49123653-2d14-4579-a213-e8263f280755", false, "testuser@leavemanagement.com" },
                    { "cb6397fe-acf8-49dd-b791-01bf0b069aee", 0, "adb2ad4efab64d049c8a713991f0bd37", new DateTime(1990, 7, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "admin@localhost.com", true, "Admin", "Default", false, null, "ADMIN@LOCALHOST.COM", "ADMIN@LOCALHOST.COM", "AQAAAAIAAYagAAAAEN5WCPZ+e5Tcc6puplTNrflD+R6WpF82fsT2aCWMlDDmwAlhys5FMsfFVgax4+GI7Q==", null, false, "26d82787-3f4c-4fe2-b6c6-1660a3c8d58a", false, "admin@localhost.com" }
                });
